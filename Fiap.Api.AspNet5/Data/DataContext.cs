...
namespace Fiap.Api.AspNet5.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)      // Este metodo vai popular as tabelas quando elas forem criadas no migration
        {

    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", 2, new DateTime(2023, 6, 1, 21, 10, 26, 593, DateTimeKind.Local).AddTicks(1710), "Apple iPhone 12", 2, "iPhone 12 mini", 5000m, "SKUIPH12" },
                    { 2, "", 2, new DateTime(2023, 6, 1, 21, 10, 26, 593, DateTimeKind.Local).AddTicks(1737), "Apple iPhone 11", 2, "iPhone 11", 11000m, "SKUIPH11" },
                    { 3, "", 2, new DateTime(2023, 6, 1, 21, 10, 26, 593, DateTimeKind.Local).AddTicks(1738), "Apple iPhone 12", 2, "iPhone 12", 12000m, "SKUIPH12" },
                    { 4, "", 2, new DateTime(2023, 6, 1, 21, 10, 26, 593, DateTimeKind.Local).AddTicks(1739), "Apple iPhone 13", 2, "iPhone 13", 13000m, "SKUIPH13" }
                });
